...
import (
	...
	"github.com/Ecosystem-Knowledge/go-ecoterium/gossip/emitter/mock"
...
//go:generate go run github.com/golang/mock/mockgen -package=mock -destination=mock/world.go github.com/Ecosystem-Knowledge/go-ecoterium/gossip/emitter External,TxPool,TxSigner,Signer
