...
opera:
	...
	go build \
	    -ldflags "-s -w -X github.com/Ecosystem-Knowledge/go-ecoterium/cmd/opera/launcher.gitCommit=$${GIT_COMMIT} -X github.com/Ecosystem-Knowledge/go-ecoterium/cmd/opera/launcher.gitDate=$${GIT_DATE}" \
	    -o build/opera \
	    ./cmd/opera
